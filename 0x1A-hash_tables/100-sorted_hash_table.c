...
/**
 * shash_table_create - A functin that creates a hash table.
...
/**
 * shash_table_set - A function that setskey value pair in the hash table.
 * @ht: A pointer to hash table to set i
 ...
 * @ht: A pointer to hash table to pull vue from.
 * @key: The key to get value from hash tble.
...
/**
 * shash_table_print - prints the contentof a hash table
